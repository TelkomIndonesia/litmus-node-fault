...
import experiments.kubernetes.node_restart_chaos.experiment.node_restart_chaos as node_restart_chaos
import argparse
import logging
...
def main():
	...
	elif args.name == "node-restart-chaos":
		node_restart_chaos.Experiment(clients)
	else:
